...
class CreateRechargesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('recharges', function (Blueprint $table) {
            ...
            $table->decimal('used_coin', 32, 5)->default(0.00000)->comment('已使用金额');
            $table->decimal('pledge', 32, 5)->default(0.00000)->comment('质押币');
            $table->decimal('gas_fee', 32, 5)->default(0.00000)->comment('GAS 费');
            ...
            $table->decimal('return_coin', 32, 5)->default(0.00000)->comment('退回金额');
