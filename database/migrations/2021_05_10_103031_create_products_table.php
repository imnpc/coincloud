...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->decimal('price', 16, 2)->default(0.00)->comment('人民币价格');
            $table->decimal('price_usdt', 16, 2)->default(0.00)->comment('USDT 价格');
            $table->decimal('price_coin', 16, 2)->default(0.00)->comment('虚拟币价格');
            ...
            $table->decimal('service_rate', 5, 2)->default(0.00)->comment('系统服务费比例');
            ...
            $table->decimal('bonus_team_a', 5, 2)->default(0.00)->comment('分红池 A 比例');
            $table->decimal('bonus_team_b', 5, 2)->default(0.00)->comment('分红池 B 比例');
            $table->decimal('bonus_team_c', 5, 2)->default(0.00)->comment('分红池 C 比例');
            ...
            $table->decimal('risk_rate', 5, 2)->default(0.00)->comment('风控池比例');
            ...
            $table->decimal('valid_rate', 5, 2)->default(0.00)->comment('有效T数比例');
            $table->decimal('package_rate', 5, 2)->default(0.00)->comment('封装比例');
